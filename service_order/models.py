...
class ServiceOrder(models.Model):
    ...
    diagnose_date = models.DateTimeField(verbose_name='Fecha de diagnóstico', blank=True, null=True)
    diagnose_comments = models.TextField(verbose_name='Observaciones de diagnostico', blank=True, null=True)
    repair_date = models.DateTimeField(verbose_name='Fecha de reparación', blank=True, null=True)
    repair_comments = models.TextField(verbose_name='Observaciones de reparación', blank=True, null=True)
    cancel_date = models.DateTimeField(verbose_name='Fecha de cancelación', blank=True, null=True)
    cancel_comments = models.TextField(verbose_name='Motivo de cancelación', blank=True, null=True)
    ...
    services_description = models.TextField(verbose_name='Observaciones del servicio', blank=True, null=True)
...
class ServiceOrderImages(models.Model):
    ...
    flowStatus_related = models.CharField(verbose_name='Estado de orden relacionado',max_length=50,default='pending')
